...
export function seedState() {
  ...
  return {
    ...
    exercises: {
      erik: [
        // Tag 1 — Push
        { id: "e_ohp", name: "Kurzhantel Überkopfdrücken", type: "weighted", muscleGroup: "Schultern", sets: 3, repMin: 8, repMax: 10, startLoad: 10, loadStep: 2.5, cap: null, perSide: false, safetyNote: "Kontrolliert, keine Hektik/ruckartige Bewegung — Schulter." },
        { id: "e_floor_press", name: "Kurzhantel Floor Press", type: "weighted", muscleGroup: "Brust", sets: 3, repMin: 10, repMax: 12, startLoad: 12.5, loadStep: 2.5, cap: null, perSide: false, safetyNote: null },
        { id: "e_cuban_press", name: "Band Cuban Press", type: "band", muscleGroup: "Schultern", sets: 3, repMin: 10, repMax: 12, bandLevel: "mittel", safetyNote: "Ersatz für Seitheben (Schulter-Anpassung)." },
        { id: "e_aussenrotation", name: "Band Außenrotation", type: "band", muscleGroup: "Schultern", sets: 3, repMin: 15, repMax: 17, bandLevel: "mittel", safetyNote: "Rotatorenmanschette — Aufwärm-/Präventionsübung." },
        { id: "e_face_pull", name: "Face Pull", type: "band", muscleGroup: "Schultern", sets: 3, repMin: 15, repMax: 17, bandLevel: "mittel", safetyNote: null },
        { id: "e_trizeps_pushdown", name: "Band Trizeps-Pushdown", type: "band", muscleGroup: "Trizeps", sets: 3, repMin: 15, repMax: 17, bandLevel: "mittel", safetyNote: null },

        // Tag 2 — Park: Pull + Core + Cardio
        { id: "e_hinweg_t2", name: "Hinweg joggen", type: "cardio", muscleGroup: "Cardio", cardioDefault: { duration: 12, pace: "locker" } },
        { id: "e_klimmzuege", name: "Klimmzüge", type: "bodyweight", muscleGroup: "Rücken", holdBased: false, perSide: false, sets: 5, targetVolume: 14, incrementAmount: 2, loadType: "rucksack", allowLoadProgression: true, safetyNote: "Sauber, kein Kipping, exzentrisch (Ablassen) langsam. 90 Sek Pause zwischen Sätzen." },
        { id: "e_liegestuetze", name: "Liegestütze", type: "bodyweight", muscleGroup: "Brust", holdBased: false, perSide: false, sets: 4, targetVolume: 112, incrementAmount: 4, loadType: "rucksack", allowLoadProgression: true, safetyNote: "Ellbogen ca. 45° zum Körper, nicht auf 90° ausstellen." },
        { id: "e_dips", name: "Dips", type: "bodyweight", muscleGroup: "Trizeps", holdBased: false, perSide: false, sets: 4, targetVolume: 40, incrementAmount: 2, loadType: null, allowLoadProgression: false, safetyNote: "Nur bis Oberarm-parallel absenken. KEIN Zusatzgewicht wegen Schulter." },
        { id: "e_beinheben", name: "Hängendes Beinheben", type: "bodyweight", muscleGroup: "Bauch/Core", holdBased: false, perSide: false, sets: 4, targetVolume: 48, incrementAmount: 2, loadType: null, allowLoadProgression: false, safetyNote: null },
        { id: "e_rueckweg_t2", name: "Rückweg joggen", type: "cardio", muscleGroup: "Cardio", cardioDefault: { duration: 12, pace: "locker" } },

        // Tag 3 — Beine
        { id: "e_kniebeugen", name: "Langhantel Kniebeugen", type: "weighted", muscleGroup: "Beine", sets: 3, repMin: 8, repMax: 10, startLoad: 32.5, loadStep: 2.5, cap: 45, perSide: false, safetyNote: null },
        { id: "e_rdl", name: "Langhantel Rumänisches Kreuzheben", type: "weighted", muscleGroup: "Beine", sets: 3, repMin: 10, repMax: 12, startLoad: 30, loadStep: 2.5, cap: 45, perSide: false, safetyNote: null },
        { id: "e_ausfallschritte", name: "Kurzhantel Ausfallschritte", type: "weighted", muscleGroup: "Beine", sets: 3, repMin: 12, repMax: 14, startLoad: 12.5, loadStep: 2.5, cap: null, perSide: true, safetyNote: null },
        { id: "e_wadenheben", name: "Kurzhantel Wadenheben", type: "weighted", muscleGroup: "Beine", sets: 3, repMin: 15, repMax: 17, startLoad: 20, loadStep: 2.5, cap: null, perSide: false, safetyNote: null },
        { id: "e_hip_thrust", name: "Band Hip Thrust", type: "band", muscleGroup: "Beine", sets: 3, repMin: 15, repMax: 17, bandLevel: "mittel", safetyNote: null },

        // Tag 4 — Pull/Arme
        { id: "e_rudern_vorgebeugt", name: "Kurzhantel vorgebeugtes Rudern", type: "weighted", muscleGroup: "Rücken", sets: 3, repMin: 10, repMax: 12, startLoad: 17.5, loadStep: 2.5, cap: null, perSide: false, safetyNote: null },
        { id: "e_rudern_band", name: "Band Rudern breit", type: "band", muscleGroup: "Rücken", sets: 3, repMin: 15, repMax: 17, bandLevel: "mittel", safetyNote: null },
        { id: "e_bizeps_curls", name: "Langhantel Bizeps Curls", type: "weighted", muscleGroup: "Bizeps", sets: 3, repMin: 10, repMax: 12, startLoad: 20, loadStep: 5, cap: 45, perSide: false, safetyNote: null },
        { id: "e_hammer_curls", name: "Kurzhantel Hammer Curls", type: "weighted", muscleGroup: "Bizeps", sets: 3, repMin: 12, repMax: 14, startLoad: 10, loadStep: 2.5, cap: null, perSide: false, safetyNote: null },
        { id: "e_plank", name: "Plank", type: "bodyweight", muscleGroup: "Bauch/Core", holdBased: true, perSide: false, sets: 3, targetVolume: 135, incrementAmount: 45, loadType: null, allowLoadProgression: false, safetyNote: null },

        // Tag 5 — Park: Ganzkörper-Zirkel + Cardio
        { id: "e_hinweg_t5", name: "Hinweg joggen", type: "cardio", muscleGroup: "Cardio", cardioDefault: { duration: 10, pace: "locker" } },
        { id: "e_klimmzuege_zirkel", name: "Klimmzüge (Zirkel, pro Runde)", type: "bodyweight", muscleGroup: "Rücken", holdBased: false, perSide: false, sets: 4, targetVolume: 16, incrementAmount: 2, loadType: "rucksack", allowLoadProgression: true, safetyNote: "Sauber, kein Kipping." },
        { id: "e_liegestuetze_zirkel", name: "Liegestütze (Zirkel, pro Runde)", type: "bodyweight", muscleGroup: "Brust", holdBased: false, perSide: false, sets: 4, targetVolume: 80, incrementAmount: 8, loadType: "rucksack", allowLoadProgression: true, safetyNote: "Ellbogen ca. 45° zum Körper." },
        { id: "e_ausfallschritte_zirkel", name: "Ausfallschritte Bodyweight (Zirkel, pro Runde/Bein)", type: "bodyweight", muscleGroup: "Beine", holdBased: false, perSide: true, sets: 4, targetVolume: 60, incrementAmount: 4, loadType: null, allowLoadProgression: false, safetyNote: null },
        { id: "e_situps_zirkel", name: "Sit-ups (Zirkel, pro Runde)", type: "bodyweight", muscleGroup: "Bauch/Core", holdBased: false, perSide: false, sets: 4, targetVolume: 72, incrementAmount: 8, loadType: null, allowLoadProgression: false, safetyNote: null },
        { id: "e_rueckweg_t5", name: "Rückweg joggen", type: "cardio", muscleGroup: "Cardio", cardioDefault: { duration: 10, pace: "locker" } },
      ],
      ...
      nele: [
        ...
        { id: "n_pilates_unterkoerper", name: "Pilates-Video Unterkörper", type: "pilates", muscleGroup: "Beine", startWeight: null, loadStep: 0.5, safetyNote: null },
        { id: "n_pilates_oberkoerper", name: "Pilates-Video Oberkörper", type: "pilates", muscleGroup: "Ganzkörper", startWeight: null, loadStep: 0.5, safetyNote: null },
        { id: "n_pilates_ganzkoerper", name: "Pilates-Video Ganzkörper", type: "pilates", muscleGroup: "Ganzkörper", startWeight: null, loadStep: 0.5, safetyNote: null },

        // Tag 2 — Lauf ruhig
        { id: "n_lauf_ruhig", name: "Lauf ruhig", type: "cardio", muscleGroup: "Cardio", cardioDefault: { duration: 27, pace: "locker" } },

        // Tag 3 — Ganzkörper-Kraft (Plan gibt hier kein Startgewicht vor, nur RIR — Startgewicht wird beim ersten Logging festgelegt)
        { id: "n_goblet_squat", name: "Kurzhantel Goblet Squat", type: "weighted", muscleGroup: "Beine", sets: 3, repMin: 12, repMax: 14, startLoad: null, loadStep: 2.5, cap: null, perSide: false, safetyNote: null },
        { id: "n_rudern_vorgebeugt", name: "Kurzhantel vorgebeugtes Rudern", type: "weighted", muscleGroup: "Rücken", sets: 3, repMin: 12, repMax: 14, startLoad: null, loadStep: 2.5, cap: null, perSide: false, safetyNote: null },
        { id: "n_schulterdruecken", name: "Kurzhantel Schulterdrücken", type: "weighted", muscleGroup: "Schultern", sets: 3, repMin: 10, repMax: 12, startLoad: null, loadStep: 2.5, cap: null, perSide: false, safetyNote: null },
        { id: "n_hip_thrust", name: "Band Hip Thrust", type: "band", muscleGroup: "Beine", sets: 3, repMin: 15, repMax: 17, bandLevel: "mittel", safetyNote: null },
        { id: "n_rdl", name: "Kurzhantel RDL", type: "weighted", muscleGroup: "Beine", sets: 3, repMin: 10, repMax: 12, startLoad: null, loadStep: 2.5, cap: null, perSide: false, safetyNote: "Einbeinig optional." },
        { id: "n_plank_bauch", name: "Plank (Bauch)", type: "bodyweight", muscleGroup: "Bauch/Core", holdBased: true, perSide: false, sets: 3, targetVolume: 90, incrementAmount: 30, loadType: null, allowLoadProgression: false, safetyNote: null },
        { id: "n_russian_twist", name: "Russian Twist", type: "bodyweight", muscleGroup: "Bauch/Core", holdBased: false, perSide: false, sets: 3, targetVolume: 45, incrementAmount: 15, loadType: null, allowLoadProgression: false, safetyNote: null },

        // Tag 4 — Pilates ODER Lauf mit Tempowechsel
        { id: "n_lauf_tempo", name: "Lauf mit Tempowechsel", type: "cardio", muscleGroup: "Cardio", cardioDefault: { duration: 24, pace: "locker + Tempowechsel-Intervalle" } },

        // Tag 5 (optional) — Lockerer Lauf oder Mobility/Pilates
        { id: "n_lauf_locker_t5", name: "Lockerer Lauf", type: "cardio", muscleGroup: "Cardio", cardioDefault: { duration: 25, pace: "sehr locker" } },
      ],
    },
...
export function seedNutrition() {
  return {
    ...
    dishes: [
      ...
      { id: "f1", mealType: "breakfast", name: "Porridge-Bowl", categories: ["leicht", "schnell"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "haferflocken", amount: 50 }, { ingredientId: "sojamilch", amount: 200 }, { ingredientId: "sojajoghurt", amount: 150 }, { ingredientId: "beeren", amount: 100 }, { ingredientId: "chiasamen", amount: 10 }, { ingredientId: "mandeln", amount: 10 }] }, extras: { erik: { addIngredients: [{ ingredientId: "haferflocken", amount: 30 }, { ingredientId: "erdnussbutter", amount: 20 }, { ingredientId: "banane", amount: 120 }] } } },
      ...
      { id: "f3", mealType: "breakfast", name: "Overnight Oats mit Sojajoghurt & Banane", categories: ["leicht", "schnell"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "haferflocken", amount: 50 }, { ingredientId: "sojamilch", amount: 150 }, { ingredientId: "sojajoghurt", amount: 150 }, { ingredientId: "banane", amount: 100 }, { ingredientId: "leinsamen", amount: 10 }] }, extras: { erik: { addIngredients: [{ ingredientId: "haferflocken", amount: 30 }, { ingredientId: "erdnussbutter", amount: 20 }, { ingredientId: "beeren", amount: 100 }] } } },
      { id: "f4", mealType: "breakfast", name: "Eiweiß-Pfannkuchen mit Sojajoghurt", categories: ["deftig"], vegan: false, excludeTags: [], base: { ingredients: [{ ingredientId: "haferflocken", amount: 40 }, { ingredientId: "ei", amount: 110 }, { ingredientId: "sojajoghurt", amount: 150 }, { ingredientId: "beeren", amount: 100 }, { ingredientId: "honig", amount: 10 }] }, extras: { erik: { addIngredients: [{ ingredientId: "ei", amount: 110 }, { ingredientId: "haferflocken", amount: 30 }, { ingredientId: "nussmus", amount: 15 }] } } },
      ...
      { id: "f6", mealType: "breakfast", name: "Chia-Pudding mit Mango & Sojajoghurt", categories: ["leicht", "schnell"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "chiasamen", amount: 40 }, { ingredientId: "kokosmilch_light", amount: 200 }, { ingredientId: "mango", amount: 100 }, { ingredientId: "kokosraspeln", amount: 10 }, { ingredientId: "sojajoghurt", amount: 200 }] }, extras: { erik: { addIngredients: [{ ingredientId: "sojajoghurt", amount: 100 }, { ingredientId: "haferflocken", amount: 30 }, { ingredientId: "erdnussbutter", amount: 15 }] } } },
      ...
      { id: "f24", mealType: "breakfast", name: "Sojajoghurt-Bowl mit Ahornsirup, Walnüssen & Granatapfel", categories: ["leicht", "schnell"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "sojajoghurt", amount: 200 }, { ingredientId: "ahornsirup", amount: 15 }, { ingredientId: "walnuesse", amount: 15 }, { ingredientId: "granatapfel", amount: 50 }] }, extras: { erik: { addIngredients: [{ ingredientId: "sojajoghurt", amount: 100 }, { ingredientId: "walnuesse", amount: 15 }, { ingredientId: "haferflocken", amount: 30 }] } } },
      ...
      // Mittag (2. Erweiterung)
      { id: "m26", mealType: "lunch", name: "Gegrillte Tofu-Spieße mit Couscous & Minz-Sojajoghurt", categories: ["deftig"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "tofu", amount: 150 }, { ingredientId: "couscous", amount: 150 }, { ingredientId: "sojajoghurt", amount: 50 }, { ingredientId: "kraeuter", amount: 5 }, { ingredientId: "zitrone", amount: 10 }] }, extras: { erik: { addIngredients: [{ ingredientId: "tofu", amount: 50 }, { ingredientId: "couscous", amount: 80 }, { ingredientId: "sojajoghurt", amount: 30 }] } } },
      { id: "m27", mealType: "lunch", name: "Gegrilltes Käse-Sandwich mit Tomatensuppe", categories: ["deftig", "schnell"], vegan: false, excludeTags: [], base: { ingredients: [{ ingredientId: "toastbrot", amount: 80 }, { ingredientId: "kaese", amount: 60 }, { ingredientId: "butter", amount: 10 }, { ingredientId: "tomate", amount: 150 }, { ingredientId: "zwiebel", amount: 30 }] }, extras: { erik: { addIngredients: [{ ingredientId: "toastbrot", amount: 40 }, { ingredientId: "kaese", amount: 30 }, { ingredientId: "tomate", amount: 50 }] } } },
      { id: "m28", mealType: "lunch", name: "Süßkartoffel-Erdnuss-Curry", categories: ["deftig"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "suesskartoffel", amount: 200 }, { ingredientId: "erdnussbutter", amount: 30 }, { ingredientId: "gemuese", amount: 150 }, { ingredientId: "weisser_reis", amount: 120 }, { ingredientId: "currypulver", amount: 5 }] }, extras: { erik: { addIngredients: [{ ingredientId: "suesskartoffel", amount: 80 }, { ingredientId: "erdnussbutter", amount: 15 }, { ingredientId: "weisser_reis", amount: 80 }] } } },
      { id: "m29", mealType: "lunch", name: "Gebackene Auberginen-Bowl mit Tahin & Granatapfel", categories: ["leicht"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "aubergine", amount: 200 }, { ingredientId: "quinoa", amount: 120 }, { ingredientId: "tahin", amount: 15 }, { ingredientId: "granatapfel", amount: 40 }, { ingredientId: "olivenoel", amount: 10 }] }, extras: { erik: { addIngredients: [{ ingredientId: "aubergine", amount: 80 }, { ingredientId: "quinoa", amount: 80 }, { ingredientId: "tahin", amount: 10 }] } } },
      { id: "m30", mealType: "lunch", name: "Räuchertofu-Bowl mit Rucola & Walnüssen", categories: ["leicht", "schnell"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "raeuchertofu", amount: 100 }, { ingredientId: "vollkornbrot", amount: 60 }, { ingredientId: "rucola", amount: 40 }, { ingredientId: "walnuesse", amount: 15 }, { ingredientId: "balsamico", amount: 10 }] }, extras: { erik: { addIngredients: [{ ingredientId: "raeuchertofu", amount: 40 }, { ingredientId: "vollkornbrot", amount: 40 }, { ingredientId: "walnuesse", amount: 15 }] } } },
      ...
      // Abend (2. Erweiterung)
      { id: "a26", mealType: "dinner", name: "Gefüllte Zucchini mit Sojagranulat-Bolognese", categories: ["deftig"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "zucchini", amount: 250 }, { ingredientId: "sojagranulat", amount: 40 }, { ingredientId: "tomatenmark", amount: 40 }, { ingredientId: "zwiebel", amount: 30 }] }, extras: { erik: { addIngredients: [{ ingredientId: "sojagranulat", amount: 20 }, { ingredientId: "zucchini", amount: 100 }, { ingredientId: "vollkornbrot", amount: 40 }] } } },
      { id: "a27", mealType: "dinner", name: "Käse-Ofenkartoffeln mit Crème fraîche", categories: ["deftig"], vegan: false, excludeTags: [], base: { ingredients: [{ ingredientId: "kartoffel", amount: 250 }, { ingredientId: "kaese", amount: 60 }, { ingredientId: "creme_fraiche", amount: 30 }, { ingredientId: "fruehlingszwiebel", amount: 15 }] }, extras: { erik: { addIngredients: [{ ingredientId: "kartoffel", amount: 100 }, { ingredientId: "kaese", amount: 30 }, { ingredientId: "creme_fraiche", amount: 20 }] } } },
      { id: "a28", mealType: "dinner", name: "Tempeh-Satay-Spieße mit Erdnusssauce & Reis", categories: ["deftig"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "tempeh", amount: 130 }, { ingredientId: "weisser_reis", amount: 150 }, { ingredientId: "erdnusssauce", amount: 25 }, { ingredientId: "gurke", amount: 40 }] }, extras: { erik: { addIngredients: [{ ingredientId: "tempeh", amount: 50 }, { ingredientId: "weisser_reis", amount: 100 }, { ingredientId: "erdnusssauce", amount: 15 }] } } },
      { id: "a29", mealType: "dinner", name: "Rote-Bete-Risotto mit Walnüssen & Hefeflocken", categories: ["deftig"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "rote_bete", amount: 150 }, { ingredientId: "weisser_reis", amount: 150 }, { ingredientId: "walnuesse", amount: 15 }, { ingredientId: "hefeflocken", amount: 15 }, { ingredientId: "zwiebel", amount: 30 }] }, extras: { erik: { addIngredients: [{ ingredientId: "weisser_reis", amount: 80 }, { ingredientId: "walnuesse", amount: 15 }, { ingredientId: "hefeflocken", amount: 10 }] } } },
      { id: "a30", mealType: "dinner", name: "Gepulltes Jackfruit mit Süßkartoffelpüree & Krautsalat", categories: ["deftig"], vegan: true, excludeTags: [], base: { ingredients: [{ ingredientId: "jackfruit", amount: 200 }, { ingredientId: "suesskartoffel", amount: 180 }, { ingredientId: "weisskohl", amount: 80 }, { ingredientId: "ketchup", amount: 25 }, { ingredientId: "worcestersauce", amount: 10 }] }, extras: { erik: { addIngredients: [{ ingredientId: "jackfruit", amount: 80 }, { ingredientId: "suesskartoffel", amount: 80 }, { ingredientId: "weisskohl", amount: 40 }] } } },
    ],
